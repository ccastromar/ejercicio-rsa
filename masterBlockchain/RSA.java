...
public class RSA {
    ...
    public String decrypt(String result) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        ...
        decryptedBytes = cipher.doFinal(base64ToBytes(result));
    ...
    public String bytesToBase64(byte[] cipherBytes) {
            String cipherText = Base64.getEncoder().encodeToString(cipherBytes);
            return cipherText;
    }
    
    public byte[] base64ToBytes(String cipherText){
            byte[] reCipherBytes = Base64.getDecoder().decode(cipherText);
            return reCipherBytes;
    }
